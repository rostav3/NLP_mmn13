...
print()
print('original tree as given in bracketed notation:\n\n{bracketed_notation_tree}\n\n')

tree_yield = get_yield(list_tree)
print('the yield extracted from the tree:\n\n{tree_yield}\n\n')

de_transliterated = list(map(to_heb, tree_yield))
print('the yeild, de-transliterated:\n\n{de_transliterated}\n\n')

reversed = list(map(lambda morpheme: morpheme[::-1], de_transliterated))[::-1]
print('finally, reversed for easy reading in LTR applications:\n\n{reversed}\n\n')
